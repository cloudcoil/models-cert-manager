# Generated by cloudcoil-model-codegen v0.5.1
# DO NOT EDIT
...
class Jks(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def password_secret_ref(self, value_or_callback: PasswordSecretRef, /) -> "Jks.Builder": ...
    ...
    containing the issuing Certificate Authority
    """
    password_secret_ref: Annotated[PasswordSecretRef, Field(alias="passwordSecretRef")]
    """
    PasswordSecretRef is a reference to a key in a Secret resource
    containing the password used to encrypt the JKS keystore.
    """
...
class Pkcs12(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def password_secret_ref(
            self, value_or_callback: PasswordSecretRef, /
        ) -> "Pkcs12.Builder": ...
